...
fn generate_vertex_attrib_pointer_calls(body: &syn::Body) -> Vec<quote::Tokens> {
    match body {
        ...
        &syn::Body::Struct(syn::VariantData::Unit) => panic!("VertexAttribPointer can not be implemented for Unit Structs"),
        &syn::Body::Struct(syn::VariantData::Tuple(_)) => panic!("VertexAttribPointer can not be implemented for Tuple Structs"),
